...
char pickField(void){// doesnt set current field
    destroyerHits = {2,2};
    ...
    cout << "WARNING RESTING GAMEBOARD RESETS PROGRESS\n";
    ...
    switch(mapChoice){
        case 1: 
                return field1[10][10];
        break;
        case 2: currentField(field2, currentPlayPen);
                return field2[10][10];
        break;
        case 3: currentField(field3, currentPlayPen);
                return field3[10][10];
        break;
        default: return field1[10][10];
...
void sunkenShip(int x){
    string arr[] = {"carrier","submarine","battleship","destroyer","crusier"};
    system("clear");
    cout <<"*   \n";
    sleep(1);
    cout <<"          *   \n";
